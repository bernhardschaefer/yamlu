...
from yamlu.polyline import pairwise_segment_intersect, pairwise_segment_distance
...
def test_pairwise_segment_intersect():
    ...
    # (0,3) intersect
    intersect_matrix = pairwise_segment_intersect(line_segments, line_segments)
...
def test_pairwise_segment_distance():
    ...
    dist_matrix = pairwise_segment_distance(line_segments, line_segments)
